const Footer = () => {
    return (
            <footer className="flex justify-center px-4  dark:text-white">
                <div className="container px-6 py-6">
                    ...
                    <div className="flex flex-col items-center justify-between md:flex-row">
                        <a href="https://codestam.com" target='_blank' className='flex justify-center items-center flex-wrap text-lg font-bold'>
                            <img className="w-8 h-8 inline-block mr-2" src="/mainLogo.svg" alt="Codestam Technologies" width={48} height={48} />
                            <span>Codestam Technologies</span>
                        </a>
